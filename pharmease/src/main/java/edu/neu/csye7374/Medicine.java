...
public class Medicine implements MedicineAPI {
	...
	public String subscribeMedicine() {
		...
		return this.medicineName
				+ " has been added to your subscription list and you will get 5% discount on it from now onwards.";// +"\n
																													// Price
																													// now
																													// ="+this.medicinePrice;
	}
	...
	public Medicine(int medicineId, String medicineName, double medicinePrice, String medicineManufacturer,
